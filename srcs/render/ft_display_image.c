...
/*   Updated: 2025/08/08 15:09:27 by nsaraiva         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "fdf.h"

static void	apply_rotation(t_data *data);
static t_3d	scale_transform(t_3d, t_map *);
static void	draw_map(t_map *map, t_data *data);
